      ...
      <Card className="w-full max-w-md">
        ...
        <CardBody>
          <form onSubmit={handleResetPassword} className="space-y-4">
            <Input label="Email" placeholder="Masukkan alamat email Anda" type="email" value={email} onChange={(e) => setEmail(e.target.value)} startContent={<Mail className="text-default-400" size={20} />} isRequired required />
        ...
        <CardFooter className="flex flex-col items-center">
          <Link href="/login" className="text-small flex items-center text-primary">
