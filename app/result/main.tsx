...
export default function SearchResults() {
  ...
  const { searchTerm, selectedCategory, currentPage, filteredProducts, setSearchTerm, setSelectedCategory, setCurrentPage, fetchProducts, filterProducts } = searchStore();
