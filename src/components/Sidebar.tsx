            ...
            <a className="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="#" aria-label="Preline">
              <svg className="w-28 h-auto" width="116" height="32" viewBox="0 0 116 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  fill="currentColor"
                />
                <path d="M1 29.5V16.5C1 9.87258 6.37258 4.5 13 4.5C19.6274 4.5 25 9.87258 25 16.5C25 23.1274 19.6274 28.5 13 28.5H12" className="stroke-blue-600 dark:strokeWhite" stroke="currentColor" strokeWidth="2" />
                <path d="M5 29.5V16.66C5 12.1534 8.58172 8.5 13 8.5C17.4183 8.5 21 12.1534 21 16.66C21 21.1666 17.4183 24.82 13 24.82H12" className="stroke-blue-600 dark:strokeWhite" stroke="currentColor" strokeWidth="2" />
            ...
            <div className="flex flex-row items-center justify-end gap-1">
              ...
              <div className="hs-dropdown [--placement:bottom-right] relative inline-flex">
                <button
                  ...
                  aria-expanded="false"
                  aria-label="Dropdown">
                  <Image className="shrink-0 size-[38px] rounded-full" src={user?.photoURL} alt="Avatar" width={0} height={0} />
                </button>
